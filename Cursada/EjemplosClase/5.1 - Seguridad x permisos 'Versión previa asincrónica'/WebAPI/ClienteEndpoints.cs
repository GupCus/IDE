...
namespace WebAPI
{
    public static class ClienteEndpoints
    {
        public static void MapClienteEndpoints(this WebApplication app)
        {
            ...
            app.MapPost("/clientes", async (ClienteDTO dto) =>
            {
                try
                {
                    ClienteService clienteService = new ClienteService();
            ...
            app.MapPut("/clientes", async (ClienteDTO dto) =>
            {
                try
                {
                    ClienteService clienteService = new ClienteService();
            ...
            app.MapGet("/clientes/criteria", async (string texto) =>
            {
                try
                {
                    ClienteService clienteService = new ClienteService();
                ...
                {
                    return Results.Problem($"Error al buscar clientes: {ex.Message}");
                }
            })
